...
function guess(btn) {
  ...
  //Guessing for online mode
    ...
    if (guessCounter == progress) {
      progress++;
      onlineHighScore++;
      document.getElementById("onlineScore").innerHTML = "Current Score: " + onlineHighScore;
      document.getElementById("formScore").setAttribute('value',onlineHighScore);
      playOnlineSequence();
    } else {
      guessCounter++;
    }
